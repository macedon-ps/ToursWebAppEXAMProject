...
namespace ToursWebAppEXAMProject.Controllers
{
	public class TourProductsRepository : ITourProduct
	{
		...
		private readonly List<TourProduct> _tourProducts = new List<TourProduct>()
		{
			...
			new TourProduct(){Id = 3, Name = "Край тысячи озер", Description = "Страна озер, невероятной северной природы и край мастеров - Карелия. На территории Карелии сохранились старинные поселения карелов, поморов, вепсов. Здесь вы познакомитесь с уникальной архитектурой, насладитесь притягательными видами и проникнитесь культурой коренных народов. Карелия хранит в себе многовековую историю. Раскрыть ее помогут Валаамский монастырь, ансамбль деревянного зодчества на острове Кижи, а мраморный каньон и водные прогулки по ладожским шхерам добавят ярких штрихов вашему отдыху."},
